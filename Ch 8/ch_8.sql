...
-- Anthony DeBarros. 9781718501072 (Kindle Location 4298). Kindle Edition. 
...
VALUES ('A2033391', '2022-03-17', 'T229901');
...
CREATE TABLE check_constraint_example (
	...
	CONSTRAINT check_salary_now_below_zero CHECK (salary >= 0)
);

-- Listing 8-9: A UNIQUE constraint example

-- Anthony DeBarros. 9781718501072 (Kindle Location 4391). Kindle Edition. 
